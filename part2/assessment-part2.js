...
function noWeakLink() {
  ...
  // CODE HERE...
  .then(Response => {
    firstUser = Response.data[0] && Response.data[0];
    thirdUser = Response.data[2] && Response.data[2];
    return Response.data[9] && Response.data[9]
  })
